...
out = subprocess.check_output(['montage', *files, '-tile', '5x5', '-geometry', '+0+0', 'tmp\\montage.jpg'])

# for n in range(0, filecount, 25):
    # print(files[n: n+25])
    # out = subprocess.check_output(['montage', *files[n: n+25], '-tile', '5x5', '-geometry', '+0+0', 'montage-{}.jpg'.format(n//25)])
    # print(out)
