...
class ColorThief {
     ...
     *
     * */
    getColor(sourceImage, quality, allowWhite) {
     ...
     *
     */
    getPalette(sourceImage, colorCount, quality, allowWhite) {
     ...
     *
     */
    getPaletteFromPixels(pixels, pixelCount, colorCount, quality, allowWhite) {
